...
const locationsData: Record<string, LocationData> = {
  ...
  hiroshima: {
    ...
    広島という破壊と再生を経験した、平和を象徴する街で育ち、美術に囲まれて育ったことで、アートに関する感性が磨かれたのかもしれません。この中学3年生での油絵体験が、その後の私の芸術人生の原点となっています。`,
    images: [
  ...
  "atis-mons": {
    ...
    アティスモンスでの日々は、特に創作のリズムと日常の観察に焦点を当てていました。朝の散歩で出会う地元の人々や、市場で ��交流、そして季節の移り変わりを敏感に捉える時間は、作品の深みと持続性を考える上で重要な経験となりました。
  ...
  "spain-casamila": {
    ...
    展示では、私の代表作であるカラフルなキャラクターたちが大型スクリーンに投影され、ガウディの建築が持つ曲線と色彩の豊かさと共鳴するような展示となりました。展示会では「Diplōma Honorificus」を受賞し、スペインとイタリア（ミラノ）の両方で作品が紹介さ
 �ました。
