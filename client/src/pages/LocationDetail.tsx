...
const locationsData: Record<string, LocationData> = {
  ...
  "tokyo-shinjuku": {
    ...
    大学の美術部に所属していた友人の影響で、今度は抽象画に挑戦することにしました。中学生の時に描いた静物画とは全く異なるアプローチに最初は戸惑いましたが、色彩と形の自由な表現に新たな可能性を感じました。

    新宿という都市の多様性と活気が、私の抽象表現に大きなインスピレーションを与えました。昼と夜で異なる顔を見せる街並み、雑多な看板や光の洪水、人々の絶え間ない流れ。これらの都市の要素を抽象的な色彩と形で表現することを試みました。

    制作を重ねるうちに、友人から「個展ができるんじゃないか」と言われるまでになりました。この言葉は私にとって大きな励みとなり、本格的にアーティストとしての道を歩む決意を固めるきっかけとなりました。
