...
const locationsData: Record<string, LocationData> = {
  ...
  'tokyo-ikebukuro': {
    ...
    longDescription: `池袋は東京の主要な商業地区の一つで、常に活気に満ちた都市空間です。
    
    ショッピングセンター、劇場、レストラン、そして数多くのエンターテイメント施設が集まるこの地域は、多様な人々が行き交う都市の縮図とも言えます。
    
    池袋での創作活動では、都市の喧騒の中に存在する静寂の瞬間や、人々の交流から生まれる都市のエネルギーを捉えることに焦点を当てました。特に印象的だったのは、早朝や深夜の時間帯に見られる都市の別の顔です。
    
    日中は活気に満ちた通りも、明け方には静寂に包まれ、都市の構造や建築の美しさが浮かび上がります。この対比が、私の作品における「静と動」「孤独と共存」というテーマの探求につながっています。
    
    また、池袋の多文化共生の側面も創作の大きな刺激となりました。様々な国籍や背景を持つ人々が共存するこの地域は、文化の交差点として、新たな表現の可能性を示唆しています。`,
    images: [
      { url: '/images/12648.jpg', caption: '夜の池袋の街並み' },
      { url: '/images/12649.jpg', caption: '早朝の静かな商店街' },
      { url: '/images/12650.jpg', caption: '雨の日の池袋駅前' },
      { url: '/images/12651.jpg', caption: '都市の中の小さな緑地' },
      { url: '/images/12652.jpg', caption: '夕暮れ時の高層ビルの風景' }
    ],
    relatedLocations: [
      { id: 'tokyo-akasaka', title: '東京・赤坂', image: '/images/12653.jpg' },
