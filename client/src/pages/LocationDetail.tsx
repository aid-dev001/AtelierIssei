...
const locationsData: Record<string, LocationData> = {
  ...
  hiroshima: {
    ...
    longDescription: `1998年、中学3年生の美術の授業で初めて手にした油絵の具。それが私の人生を大きく変える瞬間でした。

    祖父が油絵を描いていた影響もあり、美術の授業を選択したのですが、初めてキャンバスに向かった時の感動は今でも鮮明に覚えています。絵の具の香り、筆の感触、そして色が混ざり合って生まれる予想もしなかった美しさ。

    最初に描いたのは静物画でした。茶色のバッグと花、そして時計と黄色いレモンを題材にした作品です。不器用ながらも、一筆一筆に心を込めて描いた記憶があります。思うようにいかない部分も多く、何度も塗り重ねては修正を繰り返しました。

    しかし、その制作過程で味わった集中の深さと、完成した時の達成感は格別でした。色彩が織りなす豊かな表現の可能性に魅了され、「もっと描きたい」という強い衝動が生まれました。

    広島という平和と再生を象徴する街で育ち、美術との出会いを経験したことで、アートを通じて人の心に何かを伝えたいという想いが芽生えました。この中学3年生での油絵体験が、その後の私の芸術人生の原点となっています。`,
    images: [
