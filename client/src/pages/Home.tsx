    ...
    <>
      {collections?.slice(0, 3).map((collection) => {
        const collectionArtworks =
          artworks
            ?.filter((artwork) => artwork.collectionId === collection.id)
            .slice(0, 4) || [];
            ...
            <div className="container mx-auto px-4 py-24">
              <div className="max-w-4xl mx-auto">
                ...
                <VideoModal videoSrc="/videos/movie.mp4">
                  <button className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 hover:bg-white/30 text-white rounded-full backdrop-blur-sm transition-all duration-300">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-4/5 md:w-[60%] bg-white shadow-xl transform translate-y-[10%] ml-auto">
          <div className="p-16 md:p-32 space-y-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-wider text-gray-800">
              ART CONCEPT
            </h2>
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (element) {
                      ...
                      )!.textContent = location.label;
                      document.getElementById(
                        "selected-location-country",
                      )!.textContent = location.country;
                      document.getElementById(
                        "selected-location-year",
                      )!.textContent = location.year;
                      document.getElementById(
                        "selected-location-description",
                      )!.textContent = location.description;

                      // 詳細ページへのリンクを更新
                      const linkWrapper = document.getElementById(
                        "location-detail-link-wrapper",
                      );
                      if (linkWrapper) {
          ...
          >
            <div className="border-b pb-6 mb-8">
              <div className="flex items-center gap-3">
                <span
                  id="selected-location-year"
                  className="text-sm tracking-wider text-gray-500"
                >
                  1998
                </span>
                <span
                  id="selected-location-country"
                ...
                <div id="location-detail-link-wrapper">
                  <a
                    ...
                    onClick={(e) => {
                      ...
                      const locationId =
                        document
                          .getElementById("location-detail-link-wrapper")
                          ?.getAttribute("data-location-id") || "hiroshima";
                      // 詳細ページへ遷移
          ...
          {[
            {
              ...
              quote:
                "社内に飾られているのをみてとても好きになりました。よく息子と水族館に行ったので思い入れもあります。",
            },
            {
              image: "/13457.jpg",
              name: "千本倖生",
              ...
              quote:
                "大変素晴らしい絵をありがとう。いつも見ていて心が和みます。別荘ができたら飾ります。",
            },
            {
              image: "/13454.jpg",
              name: "資産家・投資家",
