    ...
    <div className="space-y-20">
      <section className="min-h-screen relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* 中央の透過カバー */}
          <div className="absolute left-1/2 -translate-x-1/2 w-[87%] bg-white" style={{ height: 'calc(100vw / 15 * 13)', top: 'calc(100vw / 15)' }}>
            {/* メインコンテンツ */}
      ...
      <section className="relative overflow-hidden" style={{ height: '80vh' }}>
        ...
        <div className="absolute md:-bottom-24 right-0 bottom-0 w-4/5 md:w-[70%] bg-white shadow-xl md:transform md:translate-y-[-2rem] ml-auto">
          <div className="p-8 md:p-24 space-y-8 md:space-y-12">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 pt-4 md:pt-8">
                <Button asChild className="w-full md:w-auto bg-[#1a1a1a] hover:bg-[#333333] text-white px-8 py-6 text-sm tracking-[0.2em] font-medium border-b border-primary/20 shadow-lg hover:shadow-xl transition-all duration-300">
                  <ScrollToTopLink href="/concept">詳しく見る</ScrollToTopLink>
                </Button>
                <Button asChild variant="outline" className="w-full md:w-auto px-8 py-6 text-sm tracking-[0.2em] font-medium border-2 hover:bg-gray-50 shadow-lg hover:shadow-xl transition-all duration-300">
