...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Art Concept Section */}
      <section className="relative overflow-hidden mb-36" style={{ height: '80vh' }}>
        <div className="absolute inset-0">
          <img
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden mb-12 p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2">
              {[
                ...
                { id: "normandy", label: "フランス・ノルマンディー", year: "2023", country: "フランス", description: "歴史と自然が織りなす風景からのインスピレーション", images: ["/images/Ludo-mediatheque-Etrepagny-Le-Patio--ML-Vittori-min-1200x900.jpg", "/images/12670.jpg", "/images/12671.jpg"] },
