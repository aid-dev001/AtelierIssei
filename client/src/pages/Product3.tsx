    ...
    <div className="fixed inset-0 bg-black/85 z-[200] flex items-center justify-center p-4" onClick={onClose}>
      <div className="relative max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          <button onClick={toggleCmykPreview} disabled={simulating} className={`rounded-full px-3 py-2 shadow transition-all flex items-center gap-1.5 disabled:opacity-50 text-xs ${cmykPreview ? "bg-white text-black border-2 border-gray-600" : "bg-white/90 hover:bg-white text-black border border-gray-400"}`} title="CMYKシミュレーション（印刷色の確認）">
                  ...
                  <div className="flex items-center gap-3 ml-1">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        ...
                        <input type="range" min={-120} max={120} value={labelOffset.x}
